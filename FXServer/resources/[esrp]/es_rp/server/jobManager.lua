...
AddEventHandler('es_rp:spawnPlayer', function()
	...
	local job = jobs[userSource] or JOB_CIVILIAN
	local spawn = job.spawns[math.random(#job.spawns)]

	if firstSpawns[userSource] == nil then
		TriggerEvent('es_rp:firstSpawn', userSource)
		firstSpawns[userSource] = true
	end
	...
	TriggerEvent('es:getPlayers', function(players)
		for i in pairs(players)do
			if jobs[players[i].get('source')] == nil then
          	...
          	TriggerClientEvent("banking:updateBalance", players[i].get('source'), (players[i].get('bank') + players[i].get('source')))
          	TriggerClientEvent("banking:addBalance", players[i].get('source'), (jobs[players[i].get('source')].salary))

			players[i].setBankBalance((players[i].get('bank') + jobs[players[i].get('source')].salary))
